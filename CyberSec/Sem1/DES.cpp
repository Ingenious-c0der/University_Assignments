...
string DES()
{
    ...
    for (int i = 0; i < 16; i++)
    {
        ...
        //std::cout<<"***************" <<std::endl;
       // std::cout<<"Right receieved "<<right<<std::endl; 
       ...
       // std::cout<<i+1<<" -> "<<res<<std::endl;
        ...
        //std::cout<<"Round "<<i+1<<": "<<left<<" "<<right<<std::endl;   
        //std::cout<<i+1<<" Right :"<<right<<std::endl;
    }
...
{
    // A 64 bit key
    string key = "0110001101101111011001010111000001110000011101010110111001100101";
    // A block of plain text of 64 bits
    pt = "0110001101101111011011010111000001101001011101000110010001110100";
    string apt = pt;
