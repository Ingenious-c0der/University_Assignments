...
encryptedText = DESEncryption("computer", "coeppune", True)
print("Binary Encrypted text: ", encryptedText)
cipher = chr(int(encryptedText[0:8], 2) % 127) + chr(int(encryptedText[8:16], 2) % 127) + chr(int(encryptedText[16:24], 2) % 127) + chr(int(encryptedText[24:32], 2) % 127) + chr(int(encryptedText[32:40], 2) % 127) + chr(int(encryptedText[40:48], 2) % 127) + chr(int(encryptedText[48:56], 2) % 127) + chr(int(encryptedText[56:64], 2) % 127)
print("Encrypted text:", cipher)

decryptedText = DESEncryption(cipher, "coeppune", False)
...
#print("Decrypted Text:", "".join([chr(int(binary, 2)) for binary in divideString(decryptedText, 8)]))                                                                                                     