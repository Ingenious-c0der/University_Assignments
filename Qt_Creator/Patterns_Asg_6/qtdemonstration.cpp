...
#include "ui_qtdemonstration.h"
QImage surface(400,400,QImage::Format_RGB888);
QtDemonstration::QtDemonstration(QWidget *parent)
    : QMainWindow(parent)
    , ui(new Ui::QtDemonstration)
{
    ui->setupUi(this);
}

QtDemonstration::~QtDemonstration()
{
    delete ui;
}

void QtDemonstration::drawCircle(float x, float y, float xc, float yc)
{
...
void QtDemonstration::on_pushButton_clicked() //slot
...
void QtDemonstration::on_pushButton_2_clicked()
{
    int x,y,q,w;
    x = ui->textEdit->toPlainText().toInt();
     y = ui->textEdit_2->toPlainText().toInt();
...
void QtDemonstration::display(int x, int y){
    surface.setPixel(x,y,qRgb(255,255,255));
}

void QtDemonstration::DDA_line(float x1, float y1, float x2, float y2)
{
    float step;
       float dx = (x2-x1);
       float dy = (y2-y1);
...
void QtDemonstration::B_circle(float xc, float yc, float r)
{
...
void QtDemonstration::on_pushButton_3_clicked()
{   int xc,yc,r; QtDemonstration figure;
...
void QtDemonstration::on_pushButton_4_clicked()
{
    int x,y,l,b; QtDemonstration figure_2;
    float k;
...
void QtDemonstration::on_pushButton_5_clicked()
{
