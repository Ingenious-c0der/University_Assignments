...
def fail_function(stage:str):
    ...
    mailItem.Body = f"This is an automated email sent by the bot developed by Sagar Abhyankar for task5 clointfusion.\nPlease find the error logs.\nThe bot failed at {stage}.\nThe error will be solved and reverted in 24 hours.\nRegards\nSagar Abhyankar"
    mailItem.Attachments.Add(os.path.join(os.getcwd(),r'logs\task5.log'))
    mailItem._oleobj_.Invoke(*(64209,0,8,0,olNS.Accounts.Item('sagarabhyankar18@gmail.com')))
    mailItem.To = "sagarabhyankar.clointfusion@gmail.com"
...
if __name__ == "__main__":
    ...
    try:
        ...
        olNS = olApp.GetNamespace("MAPI")
        mailItem = olApp.CreateItem(0)
        mailItem.Subject = "Task 5 clointfusion Sagar Abhyankar"
        mailItem.BodyFormat = 1
        mailItem.Body = "This is an automated email sent by the bot developed by Sagar Abhyankar for task5 clointfusion\n.Please find the attached file"
