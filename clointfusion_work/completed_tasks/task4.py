...
cf.browser_activate("https://avinashtechlvr.github.io/ClointFusion-Training-Task-6/")
...
with open(r"C:\Users\sagar\Desktop\clointfusion_work\generated_files\notepad-contents.txt") as file:
...
body="Clointfusion task 4 dummy email"
cf.browser_write_h(Value=body)
cf.key_press('tab')
message ="Respected Sir,\nFollowing is dummy Information made by a bot made by Sagar for task 4 of clointfusion.\n Table Conversion Data:"
