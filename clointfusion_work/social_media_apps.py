...
class Facebook:
    ...
    def upload(self,caption,image_path,image_link):
        ...
        if image_path == "" and image_link == "":
            ...
            time.sleep(1)
            self.driver.find_element_by_xpath("//div[@class = 'l9j0dhe7 du4w35lb j83agx80 pfnyh3mw taijpn5t bp9cbjyn owycx6da btwxx1t3 kt9q3ron ak7q8e6j isp2s0ed ri5dt5u2 rt8b4zig n8ej3o3l agehan2d sk4xxmp2 rq0escxv d1544ag0 tw6a2znq s1i5eluu tv7at329']").click()
            self.driver.close()
...
class Twitter:
    ...
    def login(self):
        ...
        time.sleep(2)
        self.driver.find_element_by_xpath("//div[@data-testid='ocfEnterTextNextButton']").click()
        #self.driver.find_element_by_xpath("//*[contains(., 'Next')]").click()
        time.sleep(2)
        ...
        time.sleep(2)
        self.driver.find_element_by_xpath("//div[@style='color: rgb(15, 20, 25);']").click()
